---
layout: advisory
title: 'GHSA-wjv4-x9w8-wm3h (nokogiri): Nokogiri: Possible Use-After-Free when setting
  `Document#root=` to an invalid node type'
comments: false
categories:
- nokogiri
advisory:
  ...
  title: 'Nokogiri: Possible Use-After-Free when setting `Document#root=` to an invalid
    node type'
  date: 2026-06-19
  description: |-
    ### Summary
