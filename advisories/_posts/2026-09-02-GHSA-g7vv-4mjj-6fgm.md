---
layout: advisory
title: 'GHSA-g7vv-4mjj-6fgm (alchemy_cms): Account Takeover & Privilege-Escalation
  To Admin via Stored XSS in Menu Node Name Rendered in Page Properties Configure
  Dialog'
comments: false
categories:
- alchemy_cms
advisory:
  ...
  title: Account Takeover & Privilege-Escalation To Admin via Stored XSS in Menu Node
    Name Rendered in Page Properties Configure Dialog
  date: 2026-09-02
  description: |-
